    ...
    return (
        <div className="glass-card p-6">
            ...
            <div className="flex flex-col gap-4">
                {/* Option 1: One-click Connect (Preferred) */}
                <button
                    onClick={handleConnect}
                    disabled={loading}
                    className="w-full px-4 py-2.5 rounded-lg text-sm font-semibold text-white flex items-center justify-center gap-2 transition-all hover:scale-[1.02] disabled:opacity-50"
                    style={{ background: "#24292e" }} // GitHub brand color
                >
                ...
                <div className="relative flex py-1 items-center">
                    <div className="flex-grow border-t" style={{ borderColor: "var(--hive-border)" }}></div>
                    <span className="flex-shrink-0 mx-3 text-xs" style={{ color: "var(--hive-text-secondary)" }}>OR LINK MANUALLY</span>
                    <div className="flex-grow border-t" style={{ borderColor: "var(--hive-border)" }}></div>
                </div>
                ...
                <div className="flex gap-2">
                    <input
                        ...
                        placeholder="e.g. octocat (public only)"
