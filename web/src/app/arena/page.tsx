                ...
                {leaderboard.map((p, i) => {
                    ...
                    return (
                        ...
                        >
                            {isFirst && (
                                <>
                                    <div className="absolute -top-2 -right-2 w-8 h-8 rounded-full flex items-center justify-center animate-pulse-glow" style={{ background: "linear-gradient(135deg, #FFD700, #FFA500)" }}>
                                        <Crown className="w-4 h-4 text-white" />
                                    </div>
                                    <div className="absolute inset-0 rounded-xl" style={{ boxShadow: "0 0 30px rgba(255,215,0,0.2)" }} />
                                </>
                            )}
                            ...
                            <div className="w-10 text-center">
                                {isTop3 ? (
                                    ...
                                    <span className="text-sm font-bold" style={{ color: "var(--hive-text-muted)" }}>#{p.rank}</span>
                                )}
                            </div>
                            ...
                            <div
                                ...
                                style={{
                                    ...
                                    boxShadow: isTop3 ? `0 0 0 2px ${isFirst ? "rgba(255,215,0,0.5)" : i === 1 ? "rgba(192,192,192,0.5)" : "rgba(205,127,50,0.5)"}` : "none",
                                }}
                            >
                            ...
                            <div className="flex-1">
                                <div className={`font-semibold ${isFirst ? 'text-base' : 'text-sm'}`} style={{ color: isFirst ? "#FFD700" : "var(--hive-text-primary)" }}>
                                    {p.username}
                                </div>
                            ...
                            <div className="flex flex-col items-end">
                                <div className={`font-bold ${isFirst ? 'text-lg' : 'text-sm'}`} style={{ color: p.color }}>
                                    {p.elo}
                                </div>
                            ...
                            {isTop3 && (
                                <div className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" style={{
                                    background: `radial-gradient(circle at center, ${p.color}10, transparent)`,
                                }} />
                            )}
                        </motion.div>
                    );
    ...
    return (
        <div className="min-h-screen relative overflow-hidden" style={{ background: "var(--hive-bg-primary)" }}>
            ...
            <main className="lg:ml-64 min-h-screen">
                ...
                <div ref={heroRef} className="relative overflow-hidden border-b" style={{ borderColor: "var(--hive-border)" }}>
                    ...
                    <div className="relative max-w-5xl mx-auto px-6 py-16">
                        ...
                        >
                            ...
                            >
                                ...
                                <span className="text-xs font-semibold uppercase tracking-wider" style={{ color: "var(--hive-accent-primary)" }}>
                            ...
                            <p className="text-lg max-w-2xl mx-auto mb-8" style={{ color: "var(--hive-text-secondary)" }}>
                            ...
                            <div className="flex items-center justify-center gap-6 text-sm">
                                <div className="flex items-center gap-2">
                                    <div className="w-2 h-2 rounded-full animate-pulse" style={{ background: "var(--hive-accent-success)" }} />
                                    <span style={{ color: "var(--hive-text-muted)" }}>1,247 Active Competitors</span>
                                </div>
                                        ...
                                        <div className="p-5 flex items-center justify-between">
                                            <div className="flex-1">
                                                <div className="flex items-center gap-3 mb-2">
                                                    <h3 className="font-semibold text-sm group-hover:gradient-text transition-all">{c.title}</h3>
                                                    <span
                                                        className="text-xs px-2.5 py-1 rounded-full font-semibold uppercase tracking-wide"
                                                        style={{
                                                            background: `color-mix(in srgb, ${difficultyColors[c.difficulty]} 20%, transparent)`,
                                                ...
                                                <div className="flex items-center gap-5">
                                                    <span className="text-xs flex items-center gap-1.5" style={{ color: "var(--hive-text-muted)" }}>
                                                        <Trophy className="w-3.5 h-3.5" style={{ color: "var(--hive-accent-warning)" }} />
                                                        <span className="font-semibold" style={{ color: "var(--hive-accent-warning)" }}>{c.points}</span> pts
                                                    </span>
                                                    <span className="text-xs flex items-center gap-1.5" style={{ color: "var(--hive-text-muted)" }}>
                                            ...
                                            <ChevronRight className="w-5 h-5 transition-transform group-hover:translate-x-1" style={{ color: "var(--hive-text-muted)" }} />
                                        </div>

                                        {/* Hover Glow Effect */}
                                        <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" style={{
                                            background: `radial-gradient(circle at right, ${difficultyColors[c.difficulty]}08, transparent 70%)`
                                        }} />
                                    </motion.div>
                                ))}
                            </div>
