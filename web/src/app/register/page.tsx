...
export default function RegisterPage() {
    ...
    const { loginWithGoogle, loginWithGitHub, registerWithEmail } = useAuth();
            ...
            <div className="card w-full max-w-sm p-8">
                <div className="mb-8">
                    ...
                    <p className="text-sm text-text-muted mt-1.5">
                        Join the engineering network built on merit.
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <input type="text" placeholder="Full name" value={name} onChange={(e) => setName(e.target.value)} className="input-field" autoComplete="name" />
                    ...
                    <input type="password" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} className="input-field" autoComplete="new-password" />
